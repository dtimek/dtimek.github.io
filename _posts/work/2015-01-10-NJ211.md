...
<span style="font-family: brandon-grotesque; font-size: 13px; font-weight:700;">Project Manager, User Experience, and Visual Designer</span>

<br><span style="font-family: brandon-grotesque; font-size: 13px; font-weight:700;">CHALLENGE</span>
<br><span style="font-family: brandon-grotesque; font-size: 13px; font-weight:700;">Develop a more user friendly search that returns results consisting of services and site content based off complex taxonomies.
...
<span style="font-family: brandon-grotesque; font-size: 13px; font-weight:700;">Designed a search that directs the user to use taxonomies to find the service they are looking for.
